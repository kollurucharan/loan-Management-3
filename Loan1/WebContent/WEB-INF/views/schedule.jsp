...
<body>
<h1>EMI Schedule</h1>
<% List<EMISchedule> ls = (List<EMISchedule>) request.getAttribute("schedule"); %>
<table border="1">
<tr>
    <th>date</th>
    <th>EMI Per Month</th>
...
<% for (EMISchedule item : ls) { %>
<form action="emiDates" method="get">
<tr>
    <td><%= item.getEMIDate()%></td>
    <td><%= item.getEMIAmount() %></td>
    <td><%= item.getRemainingAmount() %></td>
